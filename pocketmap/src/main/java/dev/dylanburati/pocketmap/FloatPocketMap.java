...
public class FloatPocketMap extends AbstractMap<String, Float> implements Cloneable {
  ...
  private Float putImpl(String key, Float value, boolean shouldReplace) {
  ...
  private Float computeImpl(String key, BiFunction<? super String, ? super Float, ? extends Float> remappingFunction, boolean shouldInsert, boolean shouldReplace) {
   ...
   */
  private void insertByIndex(int idx, byte[] keyContent, float value) {
